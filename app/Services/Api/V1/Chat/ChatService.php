...
class ChatService
{
     ...
     */
    public function generateResponse(string $query, int $userId): string
    {
        ...
        // Only fetch chunks for this user
        $chunks = $this->chatRepository->getRelevantChunks($embedding, $userId, 3);
